	...
	<div class="row">
		<div class="col-sm-5">
			<div class="form-group">
				...
				{!! Form::select('tipodocumento_id', $tipodocumento,$empresa1{'tipodocumento_id'}, ['id' => 'tipodocumento_id','class'=>'form-control','disabled'=>'disabled']) !!}
			</div>			
			<div class="form-group">
				<label for="razonsocial">Razón Social</label>
				{!! Form::text('nombre',$empresa1{'nombre'},['id'=>'nombre','required'=>'required','class'=>'form-control','placeholder'=>'Razón Social','readonly'=>'readonly']) !!}				
			</div>			
			<div class="form-group">
		...
		<div class="col-sm-5">
			<div class="form-group">
				...
				{!! Form::text('documento',$empresa1{'documento'},['id'=>'documento','required'=>'required','class'=>'form-control','placeholder'=>'Documento','readonly'=>'readonly']) !!}
			</div>
			<div class="form-group">
			...
			<div class="form-group">
    			...
    			{!! Form::select('ciudad_id', $ciudades1,$empresa1{'ciudad_id'},['id'=>'ciudad_id','class'=>'form-control']) !!}    			
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				{!! Form::text('codigo_habilitacion',$empresa1{'codigo_habilitacion'},['id'=>'codigo_habilitacion','required'=>'required','class'=>'form-control','placeholder'=>'Código de habilitación territorial','readonly'=>'readonly']) !!}				
			</div>
		</div>
	</div>
{!! Form::close() !!}
